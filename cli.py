...
사용법:
    # 종목 기본 정보 + 현재가
    python cli.py info 005930

    # 일별 시세 수집 (CSV 저장)
    python cli.py ohlcv 005930 --start 2024-01-01 --end 2024-12-31

    # 여러 종목 한 번에
    python cli.py ohlcv 005930 000660 035420 --start 2024-01-01

    # 투자자별 거래동향
    python cli.py investor 005930 --start 2024-01-01

    # 시장 지수 (KOSPI/KOSDAQ)
    python cli.py index

    # 종목 검색
    python cli.py search 삼성
"""
