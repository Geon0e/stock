...
실행:
    python kospi200_scanner.py              # 기본 (최근 60일 데이터, 상위 10개 출력)
    python kospi200_scanner.py --top 20     # 상위 20개 출력
    python kospi200_scanner.py --days 90    # 최근 90일 데이터 사용
    python kospi200_scanner.py --out results/scan.csv  # 결과 CSV 저장
    python kospi200_scanner.py --no-cache   # 캐시 무시하고 새로 수집
"""
